...
export default {
    ...
    methods: {
        switchPageToBackGround() {
            this.$router.push("/backGroundPage")
            this.changePage = false
        },
        switchPageToFrontGround() {
...
<template>
    ...
    <div class="findTreasure">
        ...
        <img src="../../public/1.png" alt="管理者" @click="switchPageToBackGround()"  v-if="changePage" title="管理者" class="a">
        <img src="../../public/2.png" alt="使用者" @click="switchPageToFrontGround()" v-if="changePage" title="使用者" class="b">
    </div>
</template>
